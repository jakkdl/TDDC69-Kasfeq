...
\vspace{11pt}
GameComponent och DrawableGameComponent:\\
Dessa två interface är grunden till alla komponenterna i spelet. GameComponent interfacet ger tillgång till tre funktioner, init, update och dispose.\\
init:\\
...
<MORE>\\
MarioLogic:\\
En konkret implementation av en spellogik. Enda sättet att <döda> motståndaren är att hoppa på dem.\\
<more>\\
\vspace{11pt}
ResourceLoader<T>:\\
...
TiledMapLoader:\\
En klass som implementerar ResourceLoader<TiledMap> interfacet och returnerar ett TiledMap objekt som sedan används för att skapa ett PlayingField objekt.\\
<More>\\
\vspace{11pt}
