...
1. Singleton
Resurshanteraren(ResourceManager) använder det så kallade Singleton mönstret, detta gör så att koden blir renare för att vi slipper skriva static före varje funktion och fält i klassen. Och det gör också så att vi kan lagra en instans av resurshanteraren i ett fält om man nu skulle villja utöka projektet så att det blir modulärt.\\
2. Factory Method
Vi använder detta mönster i World.spawnNewPlayer som skapar en ny spelare givet en spelarfärg.\\
3. Z\ldots\\
\ldots\\
